    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#">欢迎:<span class="text-primary">${sessionScope.username}</span></a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse ">
                        <div class="panel-body">
                            <li><a href="javascript:$('#changeContent').load('user.jsp')">用户分布图</a></li>
                        </div>
                        <div class="panel-body">
                            <li><a href="javascript:$('#changeContent').load('userSeven.jsp')">用户近七天注册走势图</a></li>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <a href="javascript:$('#lay-right').load('${app}/users.jsp')">上师列表</a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
...
<nav class="navbar navbar-default navbar-fixed-bottom">
    <center>@百知教育 baizhi@Zparkhr.com.cn</center>
</nav>
</body>
</html>